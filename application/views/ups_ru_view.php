<?php $this->load->view('header_view.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-battery-half"></i> <span id="page-title"> <?= $title ?> UPS </span>
      </h1>
    </section>
      ...
      <div class="clearfix" >
        <form>
          <div class="row" >
            ...
            <div class="col-sm-6 col-md-3">
              <div class="form-group input-group">
                <span class="input-group-addon input-label">Output</span>
                <input type="number" class="form-control text-uppercase" id="txtOutput" name="txtOutput">
          ...
          <div class="row">
            <div class="col-sm-6 col-md-3">
              <div class="form-group input-group">
                <span class="input-group-addon input-label">Backup Time HL</span>
                <input type="number" class="form-control text-uppercase" id="txtHalfLoad" name="txtHalfLoad">
                <span class="input-group-addon">MENIT</span>
              </div>
            </div>
            <div class="col-sm-6 col-md-3">
              <div class="form-group input-group">
                <span class="input-group-addon input-label">Backup Time FL</span>
                <input type="number" class="form-control text-uppercase" id="txtFullLoad" name="txtFullLoad">
                <span class="input-group-addon">MENIT</span>
              </div>
            </div>
            <div class="col-sm-6 col-md-3">
          ...
          <div class="row">
            ...
            <div class="form-group text-center">
              ...
              <a href="<?= base_url('ups') ?>" class="btn btn-default btn-app"><i class="fa fa-times"></i><span>Batal</span></a>
            </div>
        </form>
      </div>
    </section>
...
<script src="<?= base_url(); ?>dist/js/amoi/ups_ru.js"></script>
