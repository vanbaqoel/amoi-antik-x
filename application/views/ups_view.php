<?php $this->load->view('header_view.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-battery-half"></i> - UPS
      </h1>
    </section>
                  ...
                  <div class="box box-success box-solid">
                    ...
                    <div class="box-body">
                      <div class="profile-user-info profile-user-info-striped">
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Output </div>
                          <div class="profile-info-value"><span id="txtOutput"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Backup Time HL</div>
                          <div class="profile-info-value"><span id="txtHalfLoad"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Backup Time FL</div>
                          <div class="profile-info-value"><span id="txtFullLoad"></span></div>
                        </div>
                      </div>
                    </div>
                  </div>
...
<script src="<?= base_url(); ?>dist/js/amoi/ups.js"></script>
