<?php $this->load->view('header_view.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> <span id="page-title"> <?= $title ?> MESIN ANTRIAN </span>
      </h1>
    </section>
      ...
      <div class="clearfix" >
        <form>
          <div class="row" >
            ...
            <div class="col-sm-6 col-md-3">
              <div class="form-group input-group">
                <span class="input-group-addon input-label">Counter Support</span>
                <input type="number" class="form-control text-uppercase" id="txtCounter" name="txtCounter">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6 col-md-3">
              <div class="form-group input-group">
                <span class="input-group-addon input-label">Ticket Button</span>
                <input type="number" class="form-control text-uppercase" id="txtTicket" name="txtTicket">
              </div>
            </div>
            <div class="col-sm-6 col-md-3">
              <div class="form-group input-group">
          ...
          <div class="row">
            ...
            <div class="form-group text-center">
              ...
              <a href="<?= base_url('antrian') ?>" class="btn btn-default btn-app"><i class="fa fa-times"></i><span>Batal</span></a>
            </div>
        </form>
      </div>
    </section>
...
<script src="<?= base_url(); ?>dist/js/amoi/antrian_ru.js"></script>
