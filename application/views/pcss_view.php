<?php include('header_view.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-desktop"></i> - PC SPAN/SAKTI
      </h1>
    </section>
...
<!-- Page Script -->
<script type="text/javascript"> var sk = '<?= $this->session->kd_unit; ?>';
var sname = '<?= $this->session->name; ?>';</script>
<script src="<?= base_url(); ?>dist/js/amoi/pcss.js"></script>
