<?php $this->load->view('header_view.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-picture-o"></i> - SCANNER
      </h1>
    </section>
                  ...
                  <div class="box box-success box-solid">
                    ...
                    <div class="box-body">
                      <div class="profile-user-info profile-user-info-striped">
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Scan Speed </div>
                          <div class="profile-info-value"><span id="txtScanSpeed"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Bit Depth </div>
                          <div class="profile-info-value"><span id="txtBitDepth"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Doc. Size </div>
                          <div class="profile-info-value"><span id="txtDocSize"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Interface </div>
                          <div class="profile-info-value"><span id="txtInterface"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Sent Speed </div>
                          <div class="profile-info-value"><span id="txtSentSpeed"></span></div>
                        </div>
                      </div>
                    </div>
                  </div>
...
<script src="<?= base_url(); ?>dist/js/amoi/scanner.js"></script>
