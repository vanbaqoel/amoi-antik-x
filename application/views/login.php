...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="../xvidocs/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <img src="../xvidocs/images/logo.png" height="48">
    <br>
    <a href="../xvidocs/"><b>xvi</b>docs</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Masukkan nama pengguna dan kata sandi untuk memulai</p>

    <form action="../xvidocs/index2.html" method="post">
