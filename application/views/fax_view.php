<?php $this->load->view('header_view.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-phone"></i> - FACSIMILE
      </h1>
    </section>
                  ...
                  <div class="box box-success box-solid">
                    ...
                    <div class="box-body">
                      <div class="profile-user-info profile-user-info-striped">
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Kecepatan Fax </div>
                          <div class="profile-info-value"><span id="txtSpeed"></span></div>
                        </div>
                      </div>
                    </div>
                  </div>
...
<script src="<?= base_url(); ?>dist/js/amoi/fax.js"></script>
