                  ...
                  <div class="box box-success box-solid">
                    ...
                    <div class="box-body">
                      <div class="profile-user-info profile-user-info-striped">
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Frame Rate </div>
                          <div class="profile-info-value"><span id="txtFrameRate"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Jumlah Channel</div>
                          <div class="profile-info-value"><span id="txtChannel"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Jumlah Kamera</div>
                          <div class="profile-info-value"><span id="txtKamera"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Harddisk</div>
                          <div class="profile-info-value"><span id="txtHarddisk"></span></div>
                        </div>
                      </div>
                    </div>
                  </div>
...
<script src="<?= base_url(); ?>dist/js/amoi/cctv.js"></script>
