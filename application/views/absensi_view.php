<?php $this->load->view('header_view.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-hand-paper-o"></i> - MESIN ABSENSI
      </h1>
    </section>
                  ...
                  <div class="box box-success box-solid">
                    ...
                    <div class="box-body">
                      <div class="profile-user-info profile-user-info-striped">
                        <div class="profile-info-row">
                          <div class="profile-info-name"> User Capacity </div>
                          <div class="profile-info-value"><span id="txtUserCap"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Record Capacity </div>
                          <div class="profile-info-value"><span id="txtRecordCap"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Recognition </div>
                          <div class="profile-info-value"><span id="txtRecog"></span></div>
                        </div>
                      </div>
                    </div>
                  </div>
...
<script src="<?= base_url(); ?>dist/js/amoi/absensi.js"></script>
