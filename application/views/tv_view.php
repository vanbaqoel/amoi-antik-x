<?php $this->load->view('header_view.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-television"></i> - TELEVISI
      </h1>
    </section>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Data Detail Televisi</h4>
            </div>
                  ...
                  <div class="box box-success box-solid">
                    ...
                    <div class="box-body">
                      <div class="profile-user-info profile-user-info-striped">
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Tipe Layar </div>
                          <div class="profile-info-value"><span id="txtKategori"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Ukuran Layar </div>
                          <div class="profile-info-value"><span id="txtUkuran"></span></div>
                        </div>
                      </div>
                    </div>
                  </div>
...
<script src="<?= base_url(); ?>dist/js/amoi/tv.js"></script>
