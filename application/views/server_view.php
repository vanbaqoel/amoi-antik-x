                  ...
                  <div class="box box-success box-solid">
                    ...
                    <div class="box-body">
                      <div class="profile-user-info profile-user-info-striped">
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Jml Processor </div>
                          <div class="profile-info-value"><span id="txtJmlProcessor"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Jml Core </div>
                          <div class="profile-info-value"><span id="txtJmlCore"></span></div>
                        </div>
                        <div class="profile-info-row">
