<?php $this->load->view('header_view.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-video-camera"></i> - LCD PROJECTOR
      </h1>
    </section>
                  ...
                  <div class="box box-success box-solid">
                    ...
                    <div class="box-body">
                      <div class="profile-user-info profile-user-info-striped">
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Resolusi </div>
                          <div class="profile-info-value"><span id="txtResolusi"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Brightness</div>
                          <div class="profile-info-value"><span id="txtBrightness"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Contrast Ratio</div>
                          <div class="profile-info-value"><span id="txtContrastRatio"></span></div>
                        </div>
                        <div class="profile-info-row">
                          <div class="profile-info-name"> Aspect Ratio </div>
                          <div class="profile-info-value"><span id="txtAspectRatio"></span></div>
                        </div>
                      </div>
                    </div>
                  </div>
...
<script src="<?= base_url(); ?>dist/js/amoi/projector.js"></script>
