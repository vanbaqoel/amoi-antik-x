<?php $this->load->view('header_view.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-print"></i> <span id="page-title"> <?= $title ?> PRINTER </span>
      </h1>
    </section>
      ...
      <div class="clearfix" >
        <form>
          ...
          <div class="row">
            <div class="col-sm-6 col-md-3">
              <div class="form-group input-group">
                <span class="input-group-addon input-label">Print Method</span>
                <select class="form-control select2" name="cboPrintMethod">
                  <option></option>
                  <?php
                    var_dump($ref);
                    foreach ($ref['r_print_method'] as $print_method) {
                      echo "<option value='".$print_method['kd_method']."'>".$print_method['deskripsi']."</option>";
                    }
                  ?>
                </select>
              </div>
            ...
            <div class="col-sm-6 col-md-3">
              <div class="form-group input-group">
                <span class="input-group-addon input-label">Print Speed</span>
                <input type="number" class="form-control text-uppercase" id="txtPrintSpeed" name="txtPrintSpeed">
                <span class="input-group-addon">PPM</span>
              </div>
            </div>
            <div class="col-sm-6 col-md-3">
              <div class="form-group input-group">
                <span class="input-group-addon input-label">Media Size</span>
                <select class="form-control select2" name="cboMediaSize">
                  <option>MIN. A4</option>
            ...
            <div class="col-sm-6 col-md-3">
              <div class="form-group input-group">
                <span class="input-group-addon input-label">Connectivity</span>
                <select class="form-control select2" name="cboKoneksi">
                  <option></option>
                  <?php
                    var_dump($ref);
                    foreach ($ref['r_koneksi'] as $koneksi) {
                      echo "<option value='".$koneksi['kd_con_method']."'>".$koneksi['deskripsi']."</option>";
                    }
                  ?>
                </select>
              </div>
          ...
          <div class="row">
            ...
            <div class="form-group text-center">
              ...
              <a href="<?= base_url('printer') ?>" class="btn btn-default btn-app"><i class="fa fa-times"></i><span>Batal</span></a>
            </div>
        </form>
      </div>
    </section>
...
<script src="<?= base_url(); ?>dist/js/amoi/printer_ru.js"></script>
