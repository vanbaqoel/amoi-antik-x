<?php $this->load->view('header_view.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-television"></i> <span id="page-title"> <?= $title ?> TELEVISI </span>
      </h1>
    </section>
      ...
      <div class="clearfix" >
        <form>
          <div class="row" >
            ...
            <div class="col-sm-6 col-md-3">
              <div class="form-group input-group">
                <span class="input-group-addon input-label">Tipe Layar</span>
          ...
          <div class="row">
            <div class="col-sm-6 col-md-3">
              <div class="form-group input-group">
                <span class="input-group-addon input-label">Ukuran Layar</span>
                <input type="number" class="form-control text-uppercase" id="txtUkuran" name="txtUkuran" min="0" max="99">
          ...
          <div class="row">
            ...
            <div class="form-group text-center">
              ...
              <a href="<?= base_url('tv') ?>" class="btn btn-default btn-app"><i class="fa fa-times"></i><span>Batal</span></a>
            </div>
        </form>
      </div>
    </section>
...
<script src="<?= base_url(); ?>dist/js/amoi/tv_ru.js"></script>
