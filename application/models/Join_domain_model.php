        ...
        $sql = "
            ...
            FROM (
                SELECT
                    ...
                    CASE WHEN kondisi != 4 AND status = 1 AND os = 1 THEN jml END AS f,
                    CASE WHEN kondisi != 4 AND status = 1 AND os = 3 THEN jml END AS g,
                    CASE WHEN kondisi != 4 AND status = 1 AND os = 6 THEN jml END AS h,
