	...
	public function get_all()
	{
        ...
        foreach($list as $row){
        	...
        	$rows[] = '<div class="btn-group">
                      ...
                      <button type="button" class="btn btn-sm btn-default" title="Ubah" '.($this->session->crud_locked ? 'disabled' : '').' onclick="edit_fax('."'$id_enc'".')"><i class="fa fa-pencil"></i></button>
                      <button type="button" class="btn btn-sm btn-default" title="Hapus" '.($this->session->crud_locked ? 'disabled' : '').' onclick="delete_fax('."'$id_enc'".')"><i class="fa fa-trash"></i></button>
                      </div>';
